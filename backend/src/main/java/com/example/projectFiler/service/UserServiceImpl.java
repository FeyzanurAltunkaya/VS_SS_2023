...
import com.example.projectFiler.mapper.UserMapper;
...
public class UserServiceImpl implements UserService {
  ...
  public UserDto save(UserDto userDto) {
    ...
    if (userDto.getId() != null) throw new ResponseStatusException(
      HttpStatus.BAD_REQUEST,
      "A new user should not have an id"
    );
  ...
  public UserDto update(UserDto userDto) {
    ...
    if (userDto.getId() == null) throw new ResponseStatusException(
      HttpStatus.BAD_REQUEST,
      "To update user please enter id"
    );
    userDto = userMapper.toDto(userRepository.save(userMapper.toEntity(userDto)));
