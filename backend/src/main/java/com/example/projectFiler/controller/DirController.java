...
public class DirController {
    ...
    public DirController(DirectoryRepository directoryRepository , UserRepository userRepository) {

        this.directoryRepository = directoryRepository;
        this.userRepository = userRepository;
    }
    @PostMapping
    public ResponseEntity<DirectoryEntity> createDirectory(@RequestBody DirectoryEntity directory) {
